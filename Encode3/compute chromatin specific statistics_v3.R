...
input_folder <- file.path(this.dir,"fimo_vs_methylation")
output_folder <- file.path(this.dir,"simulation")
ChIP.seq_folder <- file.path("ChIP-seq","2.filter_samples")
...
protein_files <- list.files(path = input_folder,pattern = "*.fimo_methylation_peaks.bed")
